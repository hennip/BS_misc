...
dat<-read.table(
"C:/Biom/FullLifeHistoryModel/2013/data/der/tags/datR_TagRecaps13.txt",
header=T)
summary(dat)
dim(dat)
...
path<-"C:/Biom/FullLifeHistoryModel/2013/data/der/tags/Files_csv"
...
# Tätä ei kannata päivittää, koska osa merkeistä katoaa välille 
